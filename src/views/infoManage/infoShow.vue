      ...
      <el-row class="info_row" :gutter="10">
        ...
        <el-col :span="9">
          <div class="area">
            ...
            <div class="tipsarea">
              <p>
                您的每笔交易资金，都将接受银行全程存管
                <a href="http://www.baidu.com" target="_blank">了解资金存管 》</a>
              </p>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="area">
            <div class="dataarea">
              <p class="gtitle">
                <i class="el-icon-date el-icon--left"></i>个人数据
              </p>
              ...
              <p class="morearea">
                谢谢您的关注，
                <a href="http://www.baidu.com" target="_blank">了解我的更多个人信息 》</a>
              </p>
            </div>
          </div>
        </el-col>
          ...
          <ul class="banarea">
            <li v-for="(item,index) in bandata" :key="index">
              <a
                :href="item.url"
                target="_blank"
                :style="{backgroundPosition:0 +' -'+ item.data+'px'}"
              ></a>
            </li>
          </ul>
        </el-col>
